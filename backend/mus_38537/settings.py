"""
Django settings for mus_38537 project.
...
WSGI_APPLICATION = 'mus_38537.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mus_38537 API",
    "DESCRIPTION": "API documentation for mus_38537 App",
    "VERSION": "v1",
}
